...
@Service
public class UserDocumentAccessInterceptor extends AccessInterceptor<UserDocument> {
    ...
    public void init() {
        ...
        addPredicate(RequestURL.post("/api/documents/*/move-to-trash"), AccessPredicates.DOCUMENT_OWNER);
