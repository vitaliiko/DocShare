      ...
      <table class="table table-hover">
        ...
        <c:forEach items="${documents}" var="doc" varStatus="counter">
          <tr>
            ...
            <td><a href="<c:url value='/document/download-document-${user.id}-${doc.id}' />" class="btn btn-success custom-width">download</a></td>
            <td><a href="<c:url value='/document/delete-document-${user.id}-${doc.id}' />" class="btn btn-danger custom-width">delete</a></td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
